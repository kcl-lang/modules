...
`jsonschema` is a module for applying JSON patches (RFC 6902) for KCL values.
...
The code source and documents are [here](https://github.com/kcl-lang/artifacthub/tree/main/jsonschema)
