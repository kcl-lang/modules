...
`istio` is the Istio spec definition

## Resource

Code source and document is [here](https://github.com/kcl-lang/artifacthub/tree/main/istio)
...
| --- | --- | --- | --- |
|**mode**|"UNDEFINED" | "CLIENT" | "SERVER" | "CLIENT_AND_SERVER"|Criteria for selecting traffic by their direction.||
...
| name | type | description | default value |
| --- | --- | --- | --- |
|**env**|[]|Specifies environment variables to be injected to this VM.||
### IstioOperator
