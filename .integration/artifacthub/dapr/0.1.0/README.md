...
`dapr` is the dapr spec definition

## Resource

Code source and document is [here](https://github.com/kcl-lang/artifacthub/tree/main/dapr)

## Index

- models
  - [Component](#component)
  - [DaprIoV1alpha1ComponentAuth](#dapriov1alpha1componentauth)
  - [DaprIoV1alpha1ComponentSpec](#dapriov1alpha1componentspec)
  - [DaprIoV1alpha1ComponentSpecMetadataItems0](#dapriov1alpha1componentspecmetadataitems0)
  - [DaprIoV1alpha1ComponentSpecMetadataItems0SecretKeyRef](#dapriov1alpha1componentspecmetadataitems0secretkeyref)
  - k8s
    - apimachinery
      - pkg
        - apis
...
| --- | --- | --- | --- |
|**apiVersion** `required` `readOnly`|"dapr.io/v1alpha1"|APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources|"dapr.io/v1alpha1"|
|**auth**|[DaprIoV1alpha1ComponentAuth](#dapriov1alpha1componentauth)|auth||
...
|**scopes**|[str]|scopes||
|**spec**|[DaprIoV1alpha1ComponentSpec](#dapriov1alpha1componentspec)|spec||
### DaprIoV1alpha1ComponentAuth
...
| name | type | description | default value |
| --- | --- | --- | --- |
|**secretStore** `required`|str|secret store||
### DaprIoV1alpha1ComponentSpec
...
|**initTimeout**|str|init timeout||
|**metadata** `required`|[[DaprIoV1alpha1ComponentSpecMetadataItems0](#dapriov1alpha1componentspecmetadataitems0)]|metadata||
|**type** `required`|str|||
|**version** `required`|str|version||
### DaprIoV1alpha1ComponentSpecMetadataItems0
...
|**secretKeyRef**|[DaprIoV1alpha1ComponentSpecMetadataItems0SecretKeyRef](#dapriov1alpha1componentspecmetadataitems0secretkeyref)|secret key ref||
|**value**|any|value||
### DaprIoV1alpha1ComponentSpecMetadataItems0SecretKeyRef
